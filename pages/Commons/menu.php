...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded text-center perso_size20">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item perso_ColorVertMenu" href="../Global/actu.php">Nouvelles des adoptés</a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item perso_ColorRougeMenu" href="../Articles/temperature.php">Température</a>
              <a class="dropdown-item perso_ColorRougeMenu" href="../Articles/chocolat.php">Chocolat</a>
              <a class="dropdown-item perso_ColorRougeMenu" href="../Articles/plantes.php">Plantes</a>
              <a class="dropdown-item perso_ColorRougeMenu" href="../Articles/sterelisation.php">Stérélisation</a>
              <a class="dropdown-item perso_ColorRougeMenu" href="../Articles/educateur.php">Educateur</a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item perso_ColorBleuCielMenu" href="../Contact/mentions.php">Mentions</a>
            </div>
        </li>
    </ul>
  </div>
